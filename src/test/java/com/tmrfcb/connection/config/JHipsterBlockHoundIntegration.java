...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.tmrfcb.connection.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.tmrfcb.connection.security.DomainUserDetailsService", "createSpringSecurityUser");

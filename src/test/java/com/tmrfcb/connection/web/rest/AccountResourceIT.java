...
import static com.tmrfcb.connection.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static com.tmrfcb.connection.test.util.OAuth2TestUtil.authenticationToken;
import static com.tmrfcb.connection.test.util.OAuth2TestUtil.registerAuthenticationToken;
